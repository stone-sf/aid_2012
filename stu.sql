...
CREATE TABLE `hobby` (
  ...
  `level` char(1) DEFAULT NULL COMMENT '评级',
...
INSERT INTO `hobby` VALUES (1,'Joy','sing,dance','A',56800.00,NULL,'骨骼惊奇'),(2,'Abby','sing','B',14800.89,NULL,'天籁之音'),(3,'Barom','draw','B',26800.00,NULL,'当代达芬奇'),(4,'Jame','dance','C',8800.00,NULL,NULL),(5,'Emma','sing,draw','B',44800.00,NULL,NULL),(6,'Chen','sing','C',16800.00,NULL,NULL);
...
INSERT INTO `marathon` VALUES (1,'尼古拉斯赵四','1998-10-11','2021-01-01 10:10:08','02:19:48'),(2,'托尼帕克','2000-07-06','2020-12-27 19:01:08','02:38:55'),(3,'曹操','1999-05-10','2021-01-02 21:15:08','02:29:18'),(4,'斯蒂芬凯奇','1995-08-26','2021-01-25 11:55:37','02:58:40');
